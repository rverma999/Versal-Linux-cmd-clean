...
proc getTraceEvents {kernelName cuName moduleName signal targetValue {requireEnd 0}} {
  ...
  set startTimeMsec 0
  set factor 9.0
  set currDeviceName xilinx.com_xd_xilinx_vck190_base_202410_1_202410_1-0
  set currBinaryName tutorial
...
# Compute Unit Stalls
#
set computeUnits { mm2s_1 mm2s_2 s2mm }
set cuFullPaths { /vitis_design_wrapper_sim_wrapper/vitis_design_wrapper_i/vitis_design_i/VitisRegion/mm2s_1/inst/ /vitis_design_wrapper_sim_wrapper/vitis_design_wrapper_i/vitis_design_i/VitisRegion/mm2s_2/inst/ /vitis_design_wrapper_sim_wrapper/vitis_design_wrapper_i/vitis_design_i/VitisRegion/s2mm/inst/ }

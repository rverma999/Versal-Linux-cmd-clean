...
set kernel_ip_dirs [list \
 "$vpp_link_root/int/xo/ip_repo/xilinx_com_hls_mm2s_1_0" \
 "$vpp_link_root/int/xo/ip_repo/xilinx_com_hls_s2mm_1_0"]
...
dict set mem_topology_dict DDR { 0 1 }
dict set mem_topology_dict LPDDR 2

set hw_platform_info [dict create \
  hw_platform_dir              ".local/hw_platform" \
  hw_platform_file             "/tools/Xilinx/Vitis/2024.1/base_platforms/xilinx_vck190_base_202410_1/hw_emu/hw_emu.xsa" \
  hw_platform_part             "xcvc1902-vsva2197-2MP-e-S" \
  hw_platform_vbnv             "xilinx.com:xd:xilinx_vck190_base_202410_1:202410.1" \
  bb_locked_dcp                "" \
  bb_synth_dcp                 "" \
  ...
  ocl_region                   "" \
  source_view_dr_inst_path     "vitis_design_wrapper_sim_wrapper/vitis_design_wrapper_i/vitis_design_i" \
  ...
  emu_user_ip_repo             "" \
  emu_src_dir                  "" \
  emu_pfm_metadata_version     "2024.1" \
  contains_emu_dir              false \
  hw_platform_board_repo       ".local/hw_platform/board" \
  hw_platform_bconn_locked      {} \
  hw_platform_bconn_unlocked    {} \
  hw_platform_board_part       "xilinx.com:vck190:part0:3.3" \
  link_output_format           "pdi" \
  xpfm_file                    "/tools/Xilinx/Vitis/2024.1/base_platforms/xilinx_vck190_base_202410_1/xilinx_vck190_base_202410_1.xpfm" \
...
set config_info [dict create \
  ...
  no_ip_cache               false \
  remote_ip_cache          "/home/wes_2025_r_verma/capstone_project/Versal-Linux-cmd-clean_0507/gemm_extended_dma_1_burst_opr/.ipcache" \
  user_board_repo           {} \
  user_bconn                {} \
  ...
  aie_shim_validation      "$vpp_link_root/int/shim_validation.tcl" \

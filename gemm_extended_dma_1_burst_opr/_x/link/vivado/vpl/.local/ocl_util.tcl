    ...
    if {[llength ${ai_engine}] > 0 && [lsearch ${vss_cells} ${ai_engine}] != -1} {
      ...
      foreach ai ${ai_engine} {
        ...
        if {${intf_count} > 0} {
          ...
          set_property -dict [list CONFIG.NUM_CLKS ${intf_count} CONFIG.NUM_MI {0} CONFIG.NUM_NMI ${intf_count} CONFIG.NUM_SI ${intf_count}] ${gmio}
          for {set index 0} {${index} < ${intf_count}} {incr index} {
            ...
            set peer_ini_count [get_property CONFIG.NUM_NSI ${peer_parent}]
            set gmio_con [list M${padded}_INI [lindex [get_property CONFIG.CONNECTIONS ${peer}] 1]]
            set rep_con [list [lindex [get_property CONFIG.CONNECTIONS ${peer}] 0] {read_bw {0} write_bw {0}}]
            set_property CONFIG.NUM_NSI [expr ${peer_ini_count} + 1] ${peer_parent}
            set new_peer [get_bd_intf_pins ${peer_parent}/S[format %02d ${peer_ini_count}]_INI]
            set_property -dict [list CONFIG.CATEGORY {aie} CONFIG.CONNECTIONS ${gmio_con}] [get_bd_intf_pins ${gmio}/S${padded}_AXI]
            set_property CONFIG.INI_STRATEGY {load} [get_bd_intf_pins ${gmio}/M${padded}_INI]
            set_property -dict [list CONFIG.INI_STRATEGY {load} CONFIG.CONNECTIONS ${rep_con}] ${new_peer}
            ...
            connect_bd_intf_net [get_bd_intf_pins ${gmio}/M${padded}_INI] ${new_peer}
      ...
      foreach n ${noc_collapse} {
        ...
        set_property CONFIG.NUM_SI ${link_to_idx} ${n}
        #clocks
        set link_to_idx 0
        set pull_from_idx 1
        ...
        set_property CONFIG.NUM_CLKS ${link_to_idx} ${n}
      }
    }

...
(* CORE_GENERATION_INFO = "bd_05a5,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_05a5,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "vitis_design_ai_engine_0_0.hwdef" *) 
module bd_05a5
   (S00_AXI_araddr,
    S00_AXI_arburst,
    S00_AXI_arcache,

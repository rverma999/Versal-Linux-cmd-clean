...
set_property -name {XSIM.COMPILE.XSC.MORE_OPTIONS}  -value { --gcc_compile_options "-I/tools/Xilinx/Vitis_HLS/2024.1/include" --cppversion 14} -objects [current_fileset -simset]
